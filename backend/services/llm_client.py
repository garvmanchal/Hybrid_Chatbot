...
MODEL_MAP = {
    ...
    "long_context_model": "gemini-3.5-flash-lite",
...
def call_groq_fallback(prompt: str) -> LLMResult:

    fallback_model = MODEL_MAP["balanced_model"]
    ...
    return LLMResult(
        ...
        # fallback model was actually used.
    ...
    if model.startswith("gemini"):
        ...
        try:
            ...
            return LLMResult(
                ...
                needs_human_review=(
                    route == "strong_model_with_review"
                )
